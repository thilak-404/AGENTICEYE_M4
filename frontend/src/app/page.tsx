      ...
      <main className="flex-1 w-full flex flex-col items-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-24 max-w-6xl w-full">
          {[
            ...
            <div key={i} className="glass-card p-8 rounded-2xl hover:bg-white/10 transition-all cursor-default group">
        ...
        {/* Pricing Section */}
        <div className="mt-32 w-full max-w-7xl px-4 flex flex-col items-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 w-full">
            ...
            <div className="relative glass-card p-8 rounded-3xl border-2 border-pink-500 transform scale-105 shadow-[0_0_40px_rgba(255,0,153,0.3)] flex flex-col">
              <div className="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-gradient-primary px-4 py-1 rounded-full text-sm font-bold shadow-lg">
                MOST POPULAR
              </div>
